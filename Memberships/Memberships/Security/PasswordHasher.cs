...
namespace Memberships.Security
{
    public class PasswordHasher : IPasswordHasher
    {
        ...
        public string Hash(string password)
        {
            ...
            var hash = Rfc2898DeriveBytes.Pbkdf2(password, salt, _iterations, _hashAlgorithName, _keySize);
        ...
        public bool Verify(string passwordHash, string inputPassword)
        {
            ...
            var hashToVerify = Rfc2898DeriveBytes.Pbkdf2(inputPassword, salt, _iterations, _hashAlgorithName, _keySize);
